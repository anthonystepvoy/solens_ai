            ...
            <tbody>
              {results.map((row, idx) => (
                <tr key={idx} style={{ borderBottom: '1px solid #333333' }}>
                  <td style={{ padding: '10px' }}><WalletAddress address={row['Trader'] || row.trader} short={true}/></td>
                  <td style={{ padding: '10px' }}><WalletAddress address={row['Signature'] || row.signature} short={true}/></td>
                  <td style={{ padding: '10px' }}>{row['Block Delay'] || row.blockDelay || '-'}</td>
                  <td style={{ padding: '10px' }}>{row['Bot Used'] || row.botUsed || '-'}</td>
                </tr>
              ))}
            </tbody>
          </table>
